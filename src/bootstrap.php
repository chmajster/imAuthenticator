...
return compact('config','configFile','db','audit','auditIntegrity','events','settings','mail','crypto','delivery','apiKeys','access','appAdmins','conditional','auth','risk','requests','reviews','sessions','clientSecrets','passkeys','scim','directory','jwt','signingKeys','logoutPropagation','oauthAdvanced','oauthSecurity','oidc','externalIdentity','saml','magicLinks','consents','requiredActions','emails','impersonation','launcher','toolkit','housekeeping');
