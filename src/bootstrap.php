...
return compact('config','configFile','db','audit','auditIntegrity','events','settings','mail','apiKeys','access','appAdmins','conditional','auth','risk','requests','reviews','sessions','clientSecrets','passkeys','scim','directory','jwt','signingKeys','logoutPropagation','oauthAdvanced','oidc','magicLinks','consents','requiredActions','emails','impersonation','launcher','toolkit','housekeeping');
